                    ...
                    <div class="row text-sm">
                        <div class="col-md-6">
                            <address>
                                ...
                                <strong>{{__('Designation')}} :</strong>{{!empty(\Auth::user()->getDesignation($employee->designation_id ))?\Auth::user()->getDesignation($employee->designation_id )->name:''}}<br>
                                <strong>{{__('Department')}} :</strong> {{!empty(\Auth::user()->getDepartment($employee->department_id ))?\Auth::user()->getDepartment($employee->department_id )->name:''}}<br>
